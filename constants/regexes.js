...
var
	...
	USER_SOURCE            = '[^\s\0\r\n]+',
	                         ...
	                         // This isn't strictly correct, as hyphens are
							 // not allowed at the beginnings or ends of
							 // label tokens, and this regex doesn't ensure
							 // that is the case:
	HOST_SOURCE            = '[A-Za-z0-9][A-Za-z0-9\-\.]+[A-Za-z0-9]',
