...
class Connection extends EventEmitter {
	...
	parseMessage(message_string) {
		...
		if (command === Enum_ReplyNumerics[Enum_Replies.RPL_BOUNCE]) {
			if (message_string.indexOf('Try') !== 0) {
				command = Enum_Replies.RPL_ISUPPORT;
			}
		}
