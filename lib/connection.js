...
class Connection extends EventEmitter {
	...
	resetDisconnectCallbacks() {
		var prior_callbacks = this.disconnect_callbacks;
	...
	dispatchDisconnectCallbacks(error) {
		this.resetDisconnectCallbacks().forEach(function each(callback) {
			callback(error);
		});
	}
