...
var
	Error_InvalidMessage = require('./error/invalid-message');
...
class Connection extends EventEmitter {
	...
	handleRawIncomingMessage(message_string) {
		...
		try {
			...
			error = (new Error_InvalidMessage()).setRawMessage(message_string);

			return void this.handleInvalidMessageError(error);
		}
	}
	...
	/**
	 * @param {Error_InvalidMessage} error
	 * @returns {void}
	 */
	handleInvalidMessageError(error) {
