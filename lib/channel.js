...
var
	...
	InvalidChannelNickPrefixError = req('/lib/errors/invalid-channel-nick-prefix');
...
class Channel extends EventEmitter {
	...
	getChannelUserModeForNickPrefix(nick_prefix) {
		switch (nick_prefix) {
			case ChannelNickPrefixes.OWNER:
				return ChannelUserModes.OWNER;

			case ChannelNickPrefixes.ADMIN:
				return ChannelUserModes.ADMIN;

			case ChannelNickPrefixes.OPERATOR:
				return ChannelUserModes.OPERATOR;

			case ChannelNickPrefixes.HALF_OPERATOR:
				return ChannelUserModes.HALF_OPERATOR;

			case ChannelNickPrefixes.VOICED:
				return ChannelUserModes.VOICED;

			default:
				throw new InvalidChannelNickPrefixError(
					nick_prefix,
