...
class Channel extends EventEmitter {
	...
	setTopicAuthorIdentifier(nick) {
		this.topic_author_identifier = nick;
		return this;
	}

	getTopicAuthorIdentifier() {
		if (this.topic_author_identifier !== null) {
			NicknameValidator.validate(this.topic_author_identifier);
		}

		return this.topic_author_identifier;
	}
