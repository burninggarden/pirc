...
class Message {
	...
	hasSourceChannelName() {
		return this.source_channel_name !== null;
	}
	...
	setSourceChannelName(channel_name) {
		this.validateChannelName(channel_name);
		this.source_channel_name = channel_name;
		return this;
	}

	hasSourceUsername() {
		return this.source_username !== null;
	}

	getSourceUsername() {
		this.validateUsername(this.source_username);
	...
	hasSourceHostname() {
		return this.source_hostname !== null;
	}

	getSourceHostname() {
		this.validateHostname(this.source_hostname);
	...
	getChannelTargets() {
		return this.getTargets().filter(function filter(target) {
			return target.getType() === TargetTypes.CHANNEL;
		});
	}
	...
	setSourceHostname(hostname) {
		this.validateHostname(hostname);
		this.source_hostname = hostname;
		return this;
	}

	getSourceAddress() {
		return this.getSourceUsername() + '@' + this.getSourceHostname();
	}
	...
	isFromServer() {
		return this.hasSourceUsername() === false;
	}
	...
	setIsToClient(is_to_client) {
		this.is_to_client = is_to_client;
		return this;
	}

	isToClient() {
		return this.is_to_client;
	}
