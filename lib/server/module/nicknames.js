...
var
	NicknameInUseMessage     = req('/lib/message/reply/nickname-in-use'),
	ErroneousNicknameMessage = req('/lib/message/reply/erroneous-nickname'),
	NoNicknameGivenMessage   = req('/lib/message/reply/no-nickname-given'),
	RestrictedMessage        = req('/lib/message/reply/restricted');
