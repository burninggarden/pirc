...
var
	Message_Reply_Away                = require('../../message/reply/away'),
	Message_Reply_NowAway             = require('../../message/reply/now-away'),
	Message_Reply_Unaway              = require('../../message/reply/unaway'),
	Message_Reply_WhoisUser           = require('../../message/reply/whois-user'),
	Message_Reply_WhoisServer         = require('../../message/reply/whois-server'),
	Message_Reply_WhoisIdle           = require('../../message/reply/whois-idle'),
	Message_Reply_WhoisAccount        = require('../../message/reply/whois-account'),
	Message_Reply_EndOfWhois          = require('../../message/reply/end-of-whois'),
	Message_Reply_UserModeUnknownFlag = require('../../message/reply/user-mode-unknown-flag'),
	Message_Reply_UserModeIs          = require('../../message/reply/user-mode-is');
