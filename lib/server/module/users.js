...
var
	AwayMessage                = req('/lib/message/reply/away'),
	NowAwayMessage             = req('/lib/message/reply/now-away'),
	UnawayMessage              = req('/lib/message/reply/unaway'),
	WhoisUserMessage           = req('/lib/message/reply/whois-user'),
	WhoisServerMessage         = req('/lib/message/reply/whois-server'),
	WhoisIdleMessage           = req('/lib/message/reply/whois-idle'),
	WhoisAccountMessage        = req('/lib/message/reply/whois-account'),
	EndOfWhoisMessage          = req('/lib/message/reply/end-of-whois'),
	UserModeUnknownFlagMessage = req('/lib/message/reply/user-mode-unknown-flag'),
	UserModeIsMessage          = req('/lib/message/reply/user-mode-is');


var
	ModeMessage  = req('/lib/message/command/mode'),
	ErrorMessage = req('/lib/message/command/error');
