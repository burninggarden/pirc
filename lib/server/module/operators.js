...
var
	Message_Reply_YouAreOperator   = req('/lib/message/reply/you-are-operator'),
	Message_Command_Mode           = req('/lib/message/command/mode'),
	Message_Reply_PasswordMismatch = req('/lib/message/reply/password-mismatch'),
	Message_Reply_NoPrivileges     = req('/lib/message/reply/no-privileges');
