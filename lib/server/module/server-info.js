...
var
	WelcomeMessage       = req('/lib/message/reply/welcome'),
	YourHostMessage      = req('/lib/message/reply/your-host'),
	MyInfoMessage        = req('/lib/message/reply/my-info'),
	CreatedMessage       = req('/lib/message/reply/created'),
	ISupportMessage      = req('/lib/message/reply/i-support'),
	LUserClientMessage   = req('/lib/message/reply/l-user-client'),
	LUserOpMessage       = req('/lib/message/reply/l-user-op'),
	LUserUnknownMessage  = req('/lib/message/reply/l-user-unknown'),
	LUserChannelsMessage = req('/lib/message/reply/l-user-channels'),
	LUserMeMessage       = req('/lib/message/reply/l-user-me'),
	LocalUsersMessage    = req('/lib/message/reply/local-users'),
	GlobalUsersMessage   = req('/lib/message/reply/global-users'),
	StatsDLineMessage    = req('/lib/message/reply/stats-dline'),
	MotdStartMessage     = req('/lib/message/reply/motd-start'),
	MotdMessage          = req('/lib/message/reply/motd'),
	EndOfMotdMessage     = req('/lib/message/reply/end-of-motd'),
	NoMotdMessage        = req('/lib/message/reply/no-motd');
...
extend(ServerInfoModule.prototype, {
	...
	type: Enum_ModuleTypes.SERVER_INFO
