...
var
	...
	WhoisHostMessage          = req('/lib/messages/replies/whois-host'),
	WhoisIdleMessage          = req('/lib/messages/replies/whois-idle'),
	WhoisModesMessage         = req('/lib/messages/replies/whois-modes'),
	WhoisChannelsMessage      = req('/lib/messages/replies/whois-channels'),
	WhoisSecureMessage        = req('/lib/messages/replies/whois-secure'),
...
class UserModule extends Module {
	...
	getWhoisMessagesForClientAndUserDetails(client, user_details) {
		...
		if (user_details.isLocatedOnServer(this.getLocalServerDetails())) {
