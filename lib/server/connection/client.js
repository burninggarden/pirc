...
class Server_Connection_Client extends Server_Connection {
	...
	getHopCount() {
		return this.getHostServerDetails().getHopCount();
	}

	getServerToken() {
		return this.getHostServerDetails().getToken();
	}
	...
	setHostServerDetails(server_details) {
		this.host_server_details = server_details;
		return this;
	}

	getHostServerDetails() {
		return this.host_server_details;
	}
