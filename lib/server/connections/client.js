var
	...
	RemoteConnection = req('/lib/server/connections/remote'),
...
var
	...
	AlreadyRegisteredMessage = req('/lib/messages/replies/already-registered');


class ClientConnection extends RemoteConnection {
	...
	sendAlreadyRegisteredReplyForMessage(message) {
		var message = new AlreadyRegisteredMessage();
	...
	setAwayMessage(message) {
		...
		if (message) {
			user_details.addMode(UserModes.AWAY);
		} else {
			user_details.removeMode(UserModes.AWAY);
		}
