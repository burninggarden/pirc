...
var
	Message_Reply_NotOnChannel             = req('/lib/message/reply/not-on-channel'),
	Message_Reply_BannedFromChannel        = req('/lib/message/reply/banned-from-channel'),
	Message_Reply_InviteOnlyChannel        = req('/lib/message/reply/invite-only-channel'),
	Message_Reply_ChannelTopic             = req('/lib/message/reply/channel-topic'),
	Message_Reply_ChannelNoTopic           = req('/lib/message/reply/no-channel-topic'),
	Message_Reply_ChannelTopicDetails      = req('/lib/message/reply/channel-topic-details'),
	Message_Reply_NamesReply               = req('/lib/message/reply/names-reply'),
	Message_Reply_EndOfNames               = req('/lib/message/reply/end-of-names'),
	Message_Reply_ChannelIsFull            = req('/lib/message/reply/channel-is-full'),
	Message_Reply_NoChannelModes           = req('/lib/message/reply/no-channel-modes'),
	Message_Reply_UnknownMode              = req('/lib/message/reply/unknown-mode'),
	Message_Reply_OperatorPrivilegesNeeded = req('/lib/message/reply/channel-operator-privileges-needed');
...
class Server_Channel extends Channel {
	...
	handleClientMessage(client, message) {
		...
		this.clients.forEach(function each(current_client) {
			...
			var outbound_message = new Message_Command_Private();

			outbound_message.setOriginUserId(client.getUserId());
			outbound_message.setMessageBody(message.getMessageBody());
			outbound_message.setTarget(this.getName());
