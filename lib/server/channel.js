...
var
	NotOnChannelMessage             = req('/lib/message/reply/not-on-channel'),
	BannedFromChannelMessage        = req('/lib/message/reply/banned-from-channel'),
	InviteOnlyChannelMessage        = req('/lib/message/reply/invite-only-channel'),
	ChannelTopicMessage             = req('/lib/message/reply/channel-topic'),
	ChannelNoTopicMessage           = req('/lib/message/reply/no-channel-topic'),
	ChannelTopicDetailsMessage      = req('/lib/message/reply/channel-topic-details'),
	NamesReplyMessage               = req('/lib/message/reply/names-reply'),
	EndOfNamesMessage               = req('/lib/message/reply/end-of-names'),
	ChannelIsFullMessage            = req('/lib/message/reply/channel-is-full'),
	NoChannelModesMessage           = req('/lib/message/reply/no-channel-modes'),
	UnknownModeMessage              = req('/lib/message/reply/unknown-mode'),
	OperatorPrivilegesNeededMessage = req('/lib/message/reply/channel-operator-privileges-needed');
...
class ServerChannel extends Channel {
	...
	handleClientMessage(client, message) {
		...
		this.clients.forEach(function each(current_client) {
			...
			var outbound_message = new PrivateMessage();
	...
	sendOperatorPrivilegesNeededMessageToClientForModeChange(client, mode_change) {
		var message = new OperatorPrivilegesNeededMessage();
