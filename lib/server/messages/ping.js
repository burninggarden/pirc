...
class ServerPingMessage extends ServerMessage {
	...
	applyParsedParameters(middle_parameters, trailing_parameter) {
		if (middle_parameters.length !== 0) {
			console.log(middle_parameters);
			console.log(trailing_parameter);
			throw new Error('Invalid middle parameters');
		}

		this.setHostname(trailing_parameter);
	}
