...
var
	...
	getBasePath    = req('/lib/utility/get-base-path'),
	getExtension   = req('/lib/utility/get-extension'),
	stripExtension = req('/lib/utility/strip-extension'),
	getFilename    = req('/lib/utility/get-filename'),
	...
	wrapTestMethod(key, method) {
		...
		function wrappedTestMethod(test) {
			...
			method({
				...
				deepEquals:            test.deepEqual.bind(test),
				deepEqual:             test.deepEqual.bind(test),
