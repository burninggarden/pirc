...
class Client extends EventEmitter {
	...
	sendMessageToChannel(message, channel_or_channel_name) {
		var channel_name;

		if (isString(channel_or_channel_name)) {
			channel_name = channel_or_channel_name;
		} else {
			channel_name = channel_or_channel_name.getChannelDetails().getName();
		}
