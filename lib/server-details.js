...
class ServerDetails {
	...
	handleLocalUsersMessage(message) {
		this.setCurrentLocalUserCount(message.getRemoteCurrentUserCount());
		this.setMaxLocalUserCount(message.getRemoteMaxUserCount());
	}
	...
	handleGlobalUsersMessage(message) {
		this.setCurrentGlobalUserCount(
			message.getRemoteCurrentGlobalUserCount()
		);

		this.setMaxGlobalUserCount(message.getRemoteMaxGlobalUserCount());
	}
