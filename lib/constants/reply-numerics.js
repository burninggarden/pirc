...
module.exports = {
	...
	[Replies.RPL_YOURID]:           '042',

	// Note that the assignment of this particular numeric is contested; some
	// IRCD's have it labeled as "RPL_STATSDLINE", whatever that means.
	// I assume there's no relation to https://github.com/etsy/statsd - ha.
	[Replies.RPL_STATSCONN]:        '250',
