...
var
	SetterInterface           = req('/lib/server-connection/interfaces/setters'),
	ValidationInterface       = req('/lib/server-connection/interfaces/validators'),
	SocketEventInterface      = req('/lib/server-connection/interfaces/socket-events'),
	OutgoingMessagesInterface = req('/lib/server-connection/interfaces/outgoing-messages'),
	IncomingMessagesInterface = req('/lib/server-connection/interfaces/incoming-messages');
