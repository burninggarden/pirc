...
class Message_Command_User extends Message_Command {
	...
	setValuesFromParameters(parameters) {
		...
		var mode_bitmask = parameters.get('mode_bitmask');

		if (mode_bitmask) {
			this.setModeBitmask();
		}

		var hostname = parameters.get('hostname');
...
extend(Message_Command_User.prototype, {
	...
	abnf:     '(<username> " " <mode-bitmask> " * " <realname>) / (<nickname> " " <username>" " <hostname> " :" <realname>)',
	username: null,
	realname: null,
	hostname: null,
	modes:    null
