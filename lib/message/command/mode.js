...
var
	...
	ModeChangeParser   = req('/lib/parser/mode-change'),
	TargetTypes        = req('/lib/enum/target-types'),
	ModeActions        = req('/lib/enum/mode-actions'),
	ModeParameterTypes = req('/lib/enum/mode-parameter-types');
