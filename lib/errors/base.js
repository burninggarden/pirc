...
var
	...
	// Prefixed with a _ to avoid identifier collision with
	// the name of the method that shadows this utility:
	_createReply = req('/lib/utilities/create-reply');
...
class BaseError extends Error {
	...
	createReply(reply_numeric) {
		return _createReply(reply_numeric);
	}
