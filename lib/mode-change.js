...
var
	ChannelModeParameterTypes     = req('/constants/channel-mode-parameter-types'),
	UserModeParameterTypes        = req('/constants/user-mode-parameter-types'),
	ChannelUserModeParameterTypes = req('/constants/channel-user-mode-parameter-types');
