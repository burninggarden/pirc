...
var
	Enum_ChannelModeParameterTypes     = require('./enum/channel-mode-parameter-types'),
	Enum_UserModeParameterTypes        = require('./enum/user-mode-parameter-types'),
	Enum_ChannelUserModeParameterTypes = require('./enum/channel-user-mode-parameter-types');
