...
function getMultipleClientMessages(parameters) {
	function createMessage() {
		var
			message = new ClientPrivateMessage(),
			target  = ClientDetails.fromNick(parameters.nick);
...
ClientPrivateMessage.getMultipleClientMessages = getMultipleClientMessages;
