...
class ClientChannel extends Channel {
	...
	getClientDetailsForMessage(message) {
		return this.client_details_registry.getClientDetailsForMessage(message);
	}
	...
	setClientDetailsRegistry(client_details_registry) {
		this.client_details_registry = client_details_registry;
		return this;
	}
	...
	destroy() {
		...
		this.names                    = null;
		this.queued_names             = null;
		this.client_details_registry  = null;
	}
