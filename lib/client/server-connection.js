...
var
	...
	ClientDetailsRegistry  = req('/lib/client/registries/client-details'),
...
class ServerConnection extends EventEmitter {
	...
	init() {
		...
		this.client_details_registry = new ClientDetailsRegistry();
	...
	handleClientPrivateMessage(message) {
		var client = this.getClientDetailsForMessage(message);
	...
	joinChannelByName(channel_name, callback) {
		...
		channel.setClientDetailsRegistry(this.getClientDetailsRegistry());
	...
	getClientDetailsRegistry() {
		return this.client_details_registry;
	}

	getClientDetailsForMessage(message) {
		return this.getClientDetailsRegistry().getClientDetailsForMessage(
			message
		);
	}
