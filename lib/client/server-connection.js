...
var
	...
	UserDetailsRegistry = req('/lib/client/registry/user-details'),
...
var
	AwayMessage    = req('/lib/message/command/away'),
	...
	PassMessage    = req('/lib/message/command/pass'),
	NickMessage    = req('/lib/message/command/nick'),
	ModeMessage    = req('/lib/message/command/mode'),
	UserMessage    = req('/lib/message/command/user'),
	TopicMessage   = req('/lib/message/command/topic'),
	PongMessage    = req('/lib/message/command/pong'),
	WhoisMessage   = req('/lib/message/command/whois'),
	OperMessage    = req('/lib/message/command/oper'),
	QuitMessage    = req('/lib/message/command/quit'),
	RestartMessage = req('/lib/message/command/restart');
...
class ServerConnection extends Connection {
	...
	sendRestartMessage(callback) {
		var message = new RestartMessage();
