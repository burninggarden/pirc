...
class ServerConnection extends Connection {
	...
	handleNoSuchNickMessage(message) {
		...
		if (message.hasChannelTarget()) {
			...
			new_message.setChannelName(message.getFirstChannelName());
	...
	getTargetUserDetailsForMessage(message) {
		var
			target_user_details = message.getFirstUserTarget(),
	...
	createChannelForMessage(message) {
		return this.createChannelForChannelName(message.getChannelName());
	}
