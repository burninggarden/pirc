...
extend(ServerConnection.prototype, SetterInterface,           keys_to_exclude);
extend(ServerConnection.prototype, ValidationInterface,       keys_to_exclude);
extend(ServerConnection.prototype, SocketEventInterface,      keys_to_exclude);
extend(ServerConnection.prototype, OutgoingMessagesInterface, keys_to_exclude);
extend(ServerConnection.prototype, IncomingMessagesInterface, keys_to_exclude);
extend(ServerConnection.prototype, ChannelsInterface,         keys_to_exclude);
