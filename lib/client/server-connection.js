...
var
	AwayMessage    = req('/lib/messages/commands/away'),
	...
	RestartMessage = req('/lib/messages/commands/restart');
...
class ServerConnection extends Connection {
	...
	handleInboundMessage(message) {
		...
		this.emit(ConnectionEvents.INCOMING_MESSAGE, this, message);
	...
	handleModeMessage(message) {
		try {
			...
			this.emit(ConnectionEvents.CONNECTION_ERROR, this, error);
		}
	...
	handleWelcomeMessage(message) {
		...
		this.emit(ConnectionEvents.REGISTRATION_SUCCESS,this);
	}
	...
	handlePasswordMismatchMessage(message) {
		...
		if (!this.isRegistered()) {
			this.emit(ConnectionEvents.REGISTRATION_FAILURE, this, error);
		} else {
