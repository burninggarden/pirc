...
var
	...
	Parser_UserId              = req('/lib/parser/user-id');

var
	Validator_Nickname        = req('/lib/validator/nickname'),
	Validator_Hostname        = req('/lib/validator/hostname'),
	Validator_Username        = req('/lib/validator/username'),
	Validator_Realname        = req('/lib/validator/realname'),
