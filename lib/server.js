...
var
	...
	each          = req('/lib/utility/each'),
	remove        = req('/lib/utility/remove'),
	isFunction    = req('/lib/utility/is-function'),
	deferOrThrow  = req('/lib/utility/defer-or-throw'),
	createMessage = req('/lib/utility/create-message');

var
	Server_Connection_Pending = req('/lib/server/connection/pending'),
	Server_Connection_Client  = req('/lib/server/connection/client'),
	Server_Connection_Server  = req('/lib/server/connection/server');
...
var
	...
	Server_Registry_Clients = req('/lib/server/registry/clients'),
	Server_Registry_Modules = req('/lib/server/registry/modules');


var
	Server_Module_Authentication  = req('/lib/server/module/authentication'),
	Server_Module_Channels        = req('/lib/server/module/channels'),
	Server_Module_HostInfo        = req('/lib/server/module/host-info'),
	Server_Module_Nicknames       = req('/lib/server/module/nicknames'),
	Server_Module_Operators       = req('/lib/server/module/operators'),
	Server_Module_Pings           = req('/lib/server/module/pings'),
	Server_Module_PrivateMessages = req('/lib/server/module/private-messages'),
	Server_Module_Users           = req('/lib/server/module/users');
...
class Server {
	...
	initModules() {
		this.addModule(new Server_Module_Authentication());
		this.addModule(new Server_Module_Channels());
		this.addModule(new Server_Module_PrivateMessages());
		this.addModule(new Server_Module_Nicknames());
		this.addModule(new Server_Module_Users());
		this.addModule(new Server_Module_Operators());
		this.addModule(new Server_Module_Pings());
		this.addModule(new Server_Module_HostInfo());
	}
	...
	getClientRegistry() {
		if (!this.client_registry) {
			this.client_registry = new Server_Registry_Clients();
		}
	...
	getModuleRegistry() {
		if (!this.module_registry) {
			this.module_registry = new Server_Registry_Modules();
		}
